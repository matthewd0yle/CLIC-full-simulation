...
ddsim --steeringFile clic_steer.py --compactFile CLIC_o3_v14/CLIC_o3_v14.xml --inputFile whizard.001.stdhep --outputFile mySimOutputFile.slcio --numberOfEvents 100
